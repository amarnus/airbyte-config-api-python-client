...
from airbyte_config_api_client.paths.v1_source_oauths_oauth_params_create import post  # noqa: E501
from airbyte_config_api_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1SourceOauthsOauthParamsCreate(ApiTestMixin, unittest.TestCase):
    """
    V1SourceOauthsOauthParamsCreate unit test stubs
