...
from airbyte_config_api_client.paths.v1_source_definitions_list_private import post  # noqa: E501
from airbyte_config_api_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1SourceDefinitionsListPrivate(ApiTestMixin, unittest.TestCase):
    """
    V1SourceDefinitionsListPrivate unit test stubs
