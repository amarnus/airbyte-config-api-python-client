...
from airbyte_config_api_client.paths.v1_source_oauths_get_consent_url import post  # noqa: E501
from airbyte_config_api_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1SourceOauthsGetConsentUrl(ApiTestMixin, unittest.TestCase):
    """
    V1SourceOauthsGetConsentUrl unit test stubs
