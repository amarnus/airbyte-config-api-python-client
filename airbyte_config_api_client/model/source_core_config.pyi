...
class SourceCoreConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "connectionConfiguration", "workspaceId", "sourceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "connectionConfiguration", "workspaceId", "sourceId", ], str]):
