...
class DestinationDefinitionUpdate(
    ...
    dockerImageag: schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "dockerImageTag", "resourceRequirements", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dockerImageTag"]) -> typing.Union[MetaOapg.properties.dockerImageTag, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "dockerImageTag", "resourceRequirements", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        dockerImageag: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        dockerImageTag: typing.Union[MetaOapg.properties.dockerImageTag, str, schemas.Unset] = schemas.unset,
