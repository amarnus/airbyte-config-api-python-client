...
class ImportRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resourceId", "workspaceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resourceId", "workspaceId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        resourceId: typing.Union[MetaOapg.properties.resourceId, str, uuid.UUID, ],
