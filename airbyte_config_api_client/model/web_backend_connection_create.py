...
class WebBackendConnectionCreate(
        ...
        class properties:
            ...
            class operations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OperationCreate']:
                        return OperationCreate
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OperationCreate'], typing.List['OperationCreate']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'operations':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OperationCreate':
                    return super().__getitem__(i)
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceId", "destinationId", "status", "name", "namespaceDefinition", "namespaceFormat", "prefix", "operationIds", "syncCatalog", "schedule", "scheduleType", "scheduleData", "resourceRequirements", "operations", "sourceCatalogId", "geography", "nonBreakingChangesPreference", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceId", "destinationId", "status", "name", "namespaceDefinition", "namespaceFormat", "prefix", "operationIds", "syncCatalog", "schedule", "scheduleType", "scheduleData", "resourceRequirements", "operations", "sourceCatalogId", "geography", "nonBreakingChangesPreference", ], str]):
