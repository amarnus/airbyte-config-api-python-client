...
class PrivateSourceDefinitionRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinition", "granted", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinition", "granted", ], str]):
