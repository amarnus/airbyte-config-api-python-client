...
class PrivateDestinationDefinitionRead(
    ...
    granted: MetaOapg.properties.granted
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["destinationDefinition"]) -> 'DestinationDefinitionRead': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["granted"]) -> MetaOapg.properties.granted: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destinationDefinition", "granted", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["granted"]) -> MetaOapg.properties.granted: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destinationDefinition", "granted", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        destinationDefinition: 'DestinationDefinitionRead',
        granted: typing.Union[MetaOapg.properties.granted, bool, ],
