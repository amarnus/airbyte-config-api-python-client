...
class DestinationCoreConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "connectionConfiguration", "workspaceId", "destinationId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "connectionConfiguration", "workspaceId", "destinationId", ], str]):
