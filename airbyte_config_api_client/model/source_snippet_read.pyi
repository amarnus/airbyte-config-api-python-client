...
class SourceSnippetRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceId", "name", "sourceDefinitionId", "sourceName", "icon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceId", "name", "sourceDefinitionId", "sourceName", "icon", ], str]):
