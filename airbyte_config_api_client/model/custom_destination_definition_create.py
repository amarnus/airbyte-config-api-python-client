...
class CustomDestinationDefinitionCreate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def destinationDefinition() -> typing.Type['DestinationDefinitionCreate']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["destinationDefinition"]) -> 'DestinationDefinitionCreate': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "destinationDefinition", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["destinationDefinition"]) -> 'DestinationDefinitionCreate': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "destinationDefinition", ], str]):
