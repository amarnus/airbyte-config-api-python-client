...
class WorkspaceUpdateName(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "name", ], str]):
