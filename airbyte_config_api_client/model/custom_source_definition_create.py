...
class CustomSourceDefinitionCreate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def sourceDefinition() -> typing.Type['SourceDefinitionCreate']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sourceDefinition"]) -> 'SourceDefinitionCreate': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "sourceDefinition", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sourceDefinition"]) -> 'SourceDefinitionCreate': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "sourceDefinition", ], str]):
