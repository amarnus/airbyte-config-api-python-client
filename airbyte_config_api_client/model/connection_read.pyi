...
class ConnectionRead(
    ...
    breakingChange: MetaOapg.properties.breakingChange
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["connectionId", "name", "sourceId", "destinationId", "syncCatalog", "status", "breakingChange", "namespaceDefinition", "namespaceFormat", "prefix", "operationIds", "schedule", "scheduleType", "scheduleData", "resourceRequirements", "sourceCatalogId", "geography", "notifySchemaChanges", "nonBreakingChangesPreference", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["breakingChange"]) -> MetaOapg.properties.breakingChange: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        breakingChange: typing.Union[MetaOapg.properties.breakingChange, bool, ],
