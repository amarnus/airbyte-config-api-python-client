...
class ConnectionStateCreateOrUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["connectionId", "connectionState", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["connectionId", "connectionState", ], str]):
