...
class SourceDefinitionIdWithWorkspaceId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "workspaceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "workspaceId", ], str]):
