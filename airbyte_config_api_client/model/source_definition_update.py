...
class SourceDefinitionUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "dockerImageTag", "resourceRequirements", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "dockerImageTag", "resourceRequirements", ], str]):
