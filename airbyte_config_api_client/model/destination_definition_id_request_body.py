...
class DestinationDefinitionIdRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", ], str]):
