...
class SourceDefinitionIdRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", ], str]):
