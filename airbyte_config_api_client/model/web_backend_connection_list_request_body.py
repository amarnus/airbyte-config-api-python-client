...
class WebBackendConnectionListRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "sourceId", "destinationId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "sourceId", "destinationId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sourceId: typing.Union[MetaOapg.properties.sourceId, list, tuple, schemas.Unset] = schemas.unset,
        destinationId: typing.Union[MetaOapg.properties.destinationId, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
