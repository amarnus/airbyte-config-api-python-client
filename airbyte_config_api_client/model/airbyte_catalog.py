...
class AirbyteCatalog(
        ...
        class properties:
            ...
            class streams(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AirbyteStreamAndConfiguration']:
                        return AirbyteStreamAndConfiguration
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AirbyteStreamAndConfiguration'], typing.List['AirbyteStreamAndConfiguration']],
                ...
                def __getitem__(self, i: int) -> 'AirbyteStreamAndConfiguration':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["streams", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["streams", ], str]):
