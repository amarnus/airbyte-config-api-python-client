...
class OperationRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "operationId", "name", "operatorConfiguration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "operationId", "name", "operatorConfiguration", ], str]):
