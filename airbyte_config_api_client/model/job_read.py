...
class JobRead(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def status() -> typing.Type['JobStatus']:
                return JobStatus
            startedAt = schemas.Int64Schema
        
            @staticmethod
            def resetConfig() -> typing.Type['ResetConfig']:
                return ResetConfig
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resetConfig"]) -> 'ResetConfig': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "configType", "configId", "createdAt", "updatedAt", "status", "startedAt", "resetConfig", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resetConfig"]) -> typing.Union['ResetConfig', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "configType", "configId", "createdAt", "updatedAt", "status", "startedAt", "resetConfig", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        startedAt: typing.Union[MetaOapg.properties.startedAt, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        resetConfig: typing.Union['ResetConfig', schemas.Unset] = schemas.unset,
