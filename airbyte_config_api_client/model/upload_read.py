...
class UploadRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "resourceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "resourceId", ], str]):
