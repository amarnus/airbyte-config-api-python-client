...
class CompleteSourceOauthRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "workspaceId", "redirectUrl", "queryParams", "oAuthInputConfiguration", "sourceId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourceDefinitionId", "workspaceId", "redirectUrl", "queryParams", "oAuthInputConfiguration", "sourceId", ], str]):
        return super().get_item_oapg(name)
