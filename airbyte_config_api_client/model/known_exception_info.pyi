...
class KnownExceptionInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "exceptionClassName", "exceptionStack", "rootCauseExceptionClassName", "rootCauseExceptionStack", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "exceptionClassName", "exceptionStack", "rootCauseExceptionClassName", "rootCauseExceptionStack", ], str]):
