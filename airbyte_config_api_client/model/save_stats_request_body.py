...
class SaveStatsRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jobId", "attemptNumber", "stats", "streamStats", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jobId", "attemptNumber", "stats", "streamStats", ], str]):
