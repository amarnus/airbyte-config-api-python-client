...
class WebBackendOperationCreateOrUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "name", "operatorConfiguration", "operationId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "name", "operatorConfiguration", "operationId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        operationId: typing.Union[MetaOapg.properties.operationId, str, uuid.UUID, schemas.Unset] = schemas.unset,
