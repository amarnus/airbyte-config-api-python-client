...
class DestinationRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "destinationId", "workspaceId", "connectionConfiguration", "name", "destinationName", "icon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destinationDefinitionId", "destinationId", "workspaceId", "connectionConfiguration", "name", "destinationName", "icon", ], str]):
