...
SchemaFor200ResponseBodyApplicationJson = PrivateSourceDefinitionReadList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_private_source_definitions_oapg(
        self,
...
class ListPrivateSourceDefinitions(BaseApi):
    ...
    def list_private_source_definitions(
        ...
        return self._list_private_source_definitions_oapg(
            body=body,
