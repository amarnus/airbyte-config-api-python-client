...
SchemaFor200ResponseBodyApplicationJson = PrivateDestinationDefinitionReadList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_private_destination_definitions_oapg(
        self,
...
class ListPrivateDestinationDefinitions(BaseApi):
    ...
    def list_private_destination_definitions(
        ...
        return self._list_private_destination_definitions_oapg(
            body=body,
