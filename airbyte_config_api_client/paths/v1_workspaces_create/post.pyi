...
# body param
SchemaForRequestBodyApplicationJson = WorkspaceCreate


request_body_workspace_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_workspace_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_workspace_create.serialize(body, content_type)
