...
SchemaFor200ResponseBodyApplicationJson = WebBackendGeographiesListResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _web_backend_list_geographies_oapg(
        self,
...
class WebBackendListGeographies(BaseApi):
    ...
    def web_backend_list_geographies(
        ...
        return self._web_backend_list_geographies_oapg(
