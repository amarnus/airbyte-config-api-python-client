...
# body param
SchemaForRequestBodyApplicationJson = Notification
...
SchemaFor200ResponseBodyApplicationJson = NotificationRead
...
class BaseApi(api_client.Api):
    @typing.overload
    def _try_notification_config_oapg(
        self,
...
class TryNotificationConfig(BaseApi):
    ...
    def try_notification_config(
        ...
        return self._try_notification_config_oapg(
            body=body,
