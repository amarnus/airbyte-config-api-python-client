...
# body param
SchemaForRequestBodyApplicationJson = OperationIdRequestBody


request_body_operation_id_request_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OperationRead
...
class BaseApi(api_client.Api):
    ...
    def _get_operation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_operation_id_request_body.serialize(body, content_type)
