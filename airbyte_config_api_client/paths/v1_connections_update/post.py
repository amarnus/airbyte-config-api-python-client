...
# body param
SchemaForRequestBodyApplicationJson = ConnectionUpdate


request_body_connection_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_connection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_connection_update.serialize(body, content_type)
